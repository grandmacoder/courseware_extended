...
class TCCW_CourseProgress extends WP_Widget
{
	...
	function __construct()
	{
		...
		$widget_ops = array(
			...
			'description' => __('A widget that shows the current progress of the user through the selected training course.', 'coureseware_extended')
		);
		...
		/* Create the widget. */
		parent::__construct('wpcw_course_progress', __('TCCW Course Progress', 'wp-courseware'), $widget_ops, $control_ops);
	}
